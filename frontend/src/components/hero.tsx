...
export default function Hero() {
  return (
    <section className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-background to-muted p-6 dark">
      ...
      <div className="mt-6 flex flex-wrap justify-center gap-4">
        <Link to="/get-playlists">
            <Button  variant="outline" className='text-muted-foreground' size="lg">Get Started<ArrowRight className="w-4 h-4" /></Button>
        </Link>
      </div>
    </section>
  )
